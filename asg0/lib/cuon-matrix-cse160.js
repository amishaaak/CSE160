...
class Vector3 {
    ...
    magnitude() {
        // Insert your code here.
        let m = Math.pow(this.elements[0] * this.elements[0] + this.elements[1] * this.elements[1] + this.elements[2] * this.elements[2], 0.5); // Modify this line to calculate this vector's magnitude. // Modify this line to calculate this vector's magnitude.
